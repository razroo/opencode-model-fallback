...
| Path | Scope |
|------|-------|
| `.opencode/opencode-model-fallback.jsonc` | Current project |
| `.opencode/opencode-model-fallback.json` | Current project |
| `~/.config/opencode/opencode-model-fallback.jsonc` | All projects (global) |
| `~/.config/opencode/opencode-model-fallback.json` | All projects (global) |
...
opencode-model-fallback.jsonc fallback_models  ← used if no per-agent list
